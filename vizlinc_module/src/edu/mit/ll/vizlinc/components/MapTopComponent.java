...
public final class MapTopComponent extends TopComponent implements VLQueryListener
{
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(alphaRadioBtn)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jXMapKit1, javax.swing.GroupLayout.DEFAULT_SIZE, 275, Short.MAX_VALUE))
        );
    ...
    private void selectOnly(Set<LocationValue> locations)
    {
        ...
        Set<Waypoint> waypoints = getPainter().getWaypoints();
    ...
    void mapWaypoints(final Set<Waypoint> waypoints)
    {
    ...
    private class MouseHandler extends MouseAdapter
    {
         ...
         */
        private boolean selectAllInClick(Set<Waypoint> waypoints, Point mousePt)
        {
